...
func open_string(string:String) -> int:
	...
	return self.open_buffer(string.to_utf8_buffer())
...
func find_element(node_name:String) -> PackedStringArray:
...
func prettify(delimeter:String="\t", dict:Dictionary=xml_dict) -> String:
	...
	return JSON.stringify(dict, delimeter)
